...
j_{n+1}^* &= \argmin_{j \in [m]} \left( \sum_{i=j}^{m-1} \sum_{s=1}^{n} w_i^s \cdot \one_i^s + \sum_{i=0}^{j-1} \sum_{s=n+2}^{N}  w_i^s \cdot (\one_F - \one_i^s) + \sum_{i=j}^{m-1} w_i^{n+1} \cdot \one_i^{n+1}\right).
\end{align*}
